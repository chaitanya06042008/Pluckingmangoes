...
slingshot = new Slingshot(stone1.body,{x:144,y:419},10,0.04);
...
function detectCollision(stoneObj, mangoObj){
  var distance = dist(stoneObj.body.position.x, stoneObj.body.position.x, mangoObj.body.position.x,  mangoObj.body.position.x)
